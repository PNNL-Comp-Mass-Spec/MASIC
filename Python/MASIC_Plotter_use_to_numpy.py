...
plt.rcParams['font.family'] = ['Arial', 'Microsoft Sans Serif', 'Lucida Sans', 'Lucida Sans Unicode']
...
def plot_histogram(outputFilePath, columnNames, xValues, yValues, title, r_label):
    ...
    if len(yValues) == 1:
        ...
        ax.plot(xValues.to_numpy(), yValues.to_numpy(), linewidth=1, markersize=4, marker='o', color='darkblue')
    else:
        ax.plot(xValues.to_numpy(), yValues.to_numpy(), linewidth=1, color='black')
