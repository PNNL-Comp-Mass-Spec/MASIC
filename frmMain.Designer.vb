...
Partial Class frmMain
	...
	Private Sub InitializeComponent()
		...
		Me.fraInputFilePath.Text = "Input File Path (Finnigan Ion Trap .Raw or Agilent .CDF/.MGF combo or mzXML or mz" & _
		  "Data)"
		'
		'MainMenuControl
		'
		...
		Me.lblDatasetLookupFilePath.Text = "Dataset lookup file (dataset name and dataset ID number, tab-separated); used if " & _
		  "DB not available"
		'
