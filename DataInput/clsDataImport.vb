...
#End Region
    ...
    Public Sub New(masicOptions As clsMASICOptions, peakFinder As MASICPeakFinder.clsMASICPeakFinder, parentIonProcessor As clsParentIonProcessing)
        ...
        mScanTracking = New clsScanTracking(mOptions.ReporterIons, mPeakFinder)
        RegisterEvents(mScanTracking)
    ...
    Public Sub DiscardDataBelowNoiseThreshold(
      ...
      noiseThresholdOptions As MASICPeakFinder.clsBaselineNoiseOptions)
        ...
        Catch ex As Exception
            ReportError("DiscardDataBelowNoiseThreshold", "Error discarding data below the noise threshold", ex, True, True, clsMASIC.eMasicErrorCodes.UnspecifiedError)
        End Try
    ...
    Private Sub DiscardDataToLimitIonCount(
      ...
      intMaxIonCountToRetain As Integer)
        ...
        Try
            ...
            End With
        Catch ex As Exception
            ReportError("DiscardDataToLimitIonCount", "Error limiting the number of data points to " & intMaxIonCountToRetain.ToString, ex, True, True, clsMASIC.eMasicErrorCodes.UnspecifiedError)
        End Try
