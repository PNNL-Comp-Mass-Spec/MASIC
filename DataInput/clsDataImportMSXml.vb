...
Public Class clsDataImportMSXml
    ...
    Public Function ExtractScanInfoFromMZXMLDataFile(
      ...
      blnKeepMSMSSpectra As Boolean) As Boolean
        ...
        Catch ex As Exception
            ReportError("ExtractScanInfoFromMZXMLDataFile", "Error in ExtractScanInfoFromMZXMLDataFile", ex, True, True, clsMASIC.eMasicErrorCodes.InputFileDataReadError)
            Return False
        End Try
    ...
    Public Function ExtractScanInfoFromMZDataFile(
      ...
      blnKeepMSMSSpectra As Boolean) As Boolean
        ...
        Catch ex As Exception
            ReportError("ExtractScanInfoFromMZDataFile", "Error in ExtractScanInfoFromMZDataFile", ex, True, True, clsMASIC.eMasicErrorCodes.InputFileDataReadError)
            Return False
        End Try
      ...
      blnKeepMSMSSpectra As Boolean) As Boolean
        ...
        Try
            ...
            Do
                ...
                ' No Error
                If CheckScanInRange(objSpectrumInfo.ScanNumber, objSpectrumInfo.RetentionTimeMin, mOptions.SICOptions) Then
            ...
            Console.WriteLine()
        Catch ex As Exception
            ReportError("ExtractScanInfoFromMSXMLDataFile", "Error in ExtractScanInfoFromMSXMLDataFile", ex, True, True, clsMASIC.eMasicErrorCodes.InputFileDataReadError)
        End Try
      ...
      blnKeepRawSpectrum As Boolean)
        ...
        Try
            ...
            If scanInfo.IonCount > 0 Then
                ...
                ProcessAndStoreSpectrum(scanInfo, objSpectraCache, objMSSpectrum, noiseThresholdOptions, blnDiscardLowIntensityData, blnCompressSpectraData, dblMSDataResolution, blnKeepRawSpectrum)
            Else
