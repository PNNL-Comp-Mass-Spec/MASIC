      ...
      blnKeepMSMSSpectra As Boolean) As Boolean
        ...
        Try
            ...
            For intMsScanIndex = 0 To intMsScanCount - 1
                ...
                If CheckScanInRange(intScanNumber, dblScanTime, sicOptions) Then
                        ...
                        If blnSuccess AndAlso objMSSpectrum.IonCount > 0 Then
                            ...
                            With objMSSpectrum
                                ...
                                If .IonsMZ.GetLength(0) < .IonCount Then
                                    ...
                                    LogErrors("objCDFReader returned an array of data that was shorter than expected")
            ...
            Do
                ...
                If Not (blnValidFragScan AndAlso CheckScanInRange(objSpectrumInfo.ScanNumber, dblScanTime, sicOptions)) Then
                    Continue Do
                End If
            ...
            With scanList
                ...
                Do While intLastSurveyScanIndex < .SurveyScans.Count - 1
                    ...
                    If CheckScanInRange(.SurveyScans(intLastSurveyScanIndex).ScanNumber, dblScanTime, sicOptions) Then
