...
#End Region
        ...
        Try
            ...
            If File.Exists(strFilePathToCheck) Then
                ...
                If objRootElement.Name = "SICData" Then
                    ...
                    If sicOptionsCompare.DatasetNumber <> sicOptions.DatasetNumber Then Exit Try
    ...
    Public Function CreateDatasetInfoFile(
      strInputFileName As String,
      strOutputFolderPath As String,
      scanStats As List(Of DSSummarizer.clsScanStatsEntry),
      datasetFileInfo As DSSummarizer.clsDatasetStatsSummarizer.udtDatasetFileInfoType) As Boolean
        ...
        Try
            ...
            blnSuccess = objDatasetStatsSummarizer.CreateDatasetInfoFile(
              ...
              scanStats, datasetFileInfo, udtSampleInfo)
    ...
    Public Function InitializeSICDetailsTextFile(
      ...
      strOutputFolderPath As String) As Boolean
        ...
        Catch ex As Exception
            ReportError("InitializeSICDetailsTextFile", "Error initializing the XML output file" & GetFilePathPrefixChar() & strOutputFilePath, ex, True, True, eMasicErrorCodes.OutputFileWriteError)
            Return False
        End Try
    ...
    Public Function SaveHeaderGlossary(
      ...
      strOutputFolderPath As String) As Boolean
        ...
        Catch ex As Exception
            ReportError("SaveHeaderGlossary", "Error writing the Header Glossary to" & GetFilePathPrefixChar() & strOutputFilePath, ex, True, True, eMasicErrorCodes.OutputFileWriteError)
            Return False
        End Try
