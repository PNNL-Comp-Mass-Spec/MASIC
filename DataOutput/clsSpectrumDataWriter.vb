        ...
        Public Function ExportRawDataToDisk(
          ...
          strOutputFolderPath As String) As Boolean
            ...
            Try
                ...
                Select Case udtRawDataExportOptions.FileFormat
                    ...
                    Case clsRawDataExportOptions.eExportRawDataFileFormatConstants.CSVFile
                        ...
                        strOutputFilePath2 = clsDataOutput.ConstructOutputFilePath(strInputFileName, strOutputFolderPath, clsDataOutput.eOutputFileTypeConstants.DeconToolsScansFile)
            ...
            Catch ex As Exception
                LogErrors("ExportRawDataToDisk", "Error writing the raw spectra data to: " & strOutputFilePath, ex, True, True, eMasicErrorCodes.OutputFileWriteError)
                blnSuccess = False
            End Try
