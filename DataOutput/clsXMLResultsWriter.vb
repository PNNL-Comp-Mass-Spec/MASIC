    ...
    Public Function SaveDataToXML(
      ...
      dataOutputHandler As clsDataOutput) As Boolean
        ...
        Try
            ...
            objXMLOut = outputFileHandles.XMLFileForSICs
    ...
    Public Function XMLOutputFileInitialize(
      ...
      binningOptions As clsBinningOptions) As Boolean
        ...
        Try
            ...
            strXMLOutputFilePath = clsDataOutput.ConstructOutputFilePath(strInputFilePathFull, strOutputFolderPath, eOutputFileTypeConstants.XMLFile)

            outputFileHandles.XMLFileForSICs = New Xml.XmlTextWriter(strXMLOutputFilePath, Text.Encoding.UTF8)
            objXMLOut = outputFileHandles.XMLFileForSICs
